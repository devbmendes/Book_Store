...
public class BookController {
	...
	@Operation(summary = "GET A PARTICULAR BOOK", description = "Get a particular Book by ID",tags = "POST")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200")
	})
	@GetMapping("/{id}")
	...
	@Operation(summary = "GET BOOK BY NAME", description = "Get a particular Book by NAME like a RequestParam",tags = "POST")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200")
	})
	@GetMapping
